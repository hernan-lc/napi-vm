...
pub const GLOBALS: &[&str] = &[
    ...
    "Date", "Symbol", "console", "Error", "TypeError", "RangeError", "SyntaxError",
    "ReferenceError", "parseInt", "parseFloat", "isNaN", "isFinite", "undefined",
    "NaN", "Infinity", "globalThis", "window", "self",
];
...
pub const KEYWORDS: &[&str] = &[
    ...
    "finally", "throw", "new", "typeof", "instanceof", "class", "extends",
    "super", "import", "export", "from", "async", "await", "yield", "of", "in",
    "this", "null", "undefined", "true", "false", "void", "delete", "static",
];
...
pub fn builtin_members(receiver: &str) -> Option<&'static [&'static str]> {
    Some(match receiver {
        "Math" => &[
            "abs", "floor", "ceil", "round", "sqrt", "cbrt", "pow", "min", "max",
            "random", "trunc", "sign", "log", "log2", "log10", "exp", "sin", "cos",
            "tan", "hypot", "PI", "E", "LN2", "LN10", "LOG2E", "LOG10E", "SQRT1_2", "SQRT2",
        ],
        ...
        "Number" => &[
            "isNaN", "isFinite", "isInteger", "MAX_SAFE_INTEGER", "MIN_SAFE_INTEGER", "EPSILON",
        ],
        "Promise" => &["resolve", "reject", "all", "race", "allSettled", "any"],
        "Date" => &["now", "parse", "UTC"],
        "Symbol" => &["iterator", "asyncIterator", "toStringTag", "hasInstance", "for", "keyFor"],
        "String" => &["fromCharCode"],
        _ => return None,
    })
}
...
pub fn prototype_members(kind: ProtoKind) -> &'static [&'static str] {
    match kind {
        ProtoKind::Array => &[
            "length", "map", "filter", "reduce", "reduceRight", "forEach", "find",
            "some", "every", "push", "pop", "shift", "unshift", "join", "slice",
            "splice", "concat", "reverse", "sort", "flat", "flatMap", "indexOf", "includes",
        ],
        ProtoKind::String => &[
            "length", "toUpperCase", "toLowerCase", "slice", "substring", "split",
            "includes", "indexOf", "trim", "replace", "charAt", "startsWith", "endsWith", "repeat",
        ],
